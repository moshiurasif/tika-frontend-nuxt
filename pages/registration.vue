      ...
      <div class="small-container mx-auto">
        ...
        <div class="bg-white px-20 py-10 border border-gray-100">
          ...
          <div v-if="step == 'step_2'" class="">
            ...
            <p class="mb-6">
              <label class="tika-label" for="division_id"
                >Select division
              </label>
              <select
            ...
            <p v-if="districts.length" class="mb-6">
              <label class="tika-label" for="district_id"
                >Select district
              </label>
              <select
                @change.prevent="getAvailableupazillas"
                v-model="district_id"
                class="tika-input"
                id="district_id"
              >
            ...
            <p v-if="upazillas.length" class="mb-6">
              <label class="tika-label" for="upazilla_id"
                >Select upazila
              </label>
              <select
            ...
            <p v-if="centers.length" class="mb-6">
              <label class="tika-label" for="center_id"
            ...
            <div v-if="center_id" class="">
              ...
              <p class="mb-6">
                <label for="diabates" class="tika-label"
          ...
          <div v-if="step == 'step_3'">
            ...
            <div v-if="smsSent">
              <p class="mb-6">
                <label for="verify_code" class="tika-label"
                  >Verification code
                </label>
                <input
                  id="verify_code"
